...
const unhighlight_shape = state => closest_shape => 
	draw_existing_shape(state.canvas)("unhighlight")(closest_shape);
const unhighlight_shapes = state => shapes_to_unhighlight => 
	shapes_to_unhighlight.forEach((v, k) => draw_existing_shape(state.canvas)("unhighlight")(v));
